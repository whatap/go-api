...
import (
	...
	"github.com/whatap/go-api/common/util/uuidutil"
)
...
func (this *EventPack) ToString() string {
	return fmt.Sprintf("ALERT %s %s %s %s %s ", this.AbstractPack.ToString(), this.Level, this.Title, this.Message, this.Attr.ToString())
