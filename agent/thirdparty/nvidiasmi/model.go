...
type ProcessInfo struct {
	GpuInstanceId     string `xml:"gpu_instance_id" json:"gpu_instance_id"`
	ComputeInstanceId string `xml:"compute_instance_id" json:"compute_instance_id"`
	Pid               int32  `xml:"pid" json:"pid"`
	ProcessType       string `xml:"type" json:"type"`
...
type GPU struct {
	...
	Processes                                              []ProcessInfo `xml:"processes>process_info" json:"process_info"`
